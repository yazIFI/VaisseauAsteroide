...
void ListVaisseau::fillListVaisseaux(std::vector<Vaisseau *> *listV){
	...
	listV->push_back(new Vaisseau(-0.6, 0.8, 1.0f, 0.5f, 0.0f)); (*listV)[0]->setPrice(5);
	listV->push_back(new Vaisseau(-0.4, 0.8, 0.0f, 0.0f, 0.5f)); (*listV)[1]->setPrice(10);
	listV->push_back(new Vaisseau(-0.2, 0.8, 0.5f, 1.0f, 0.5f)); (*listV)[2]->setPrice(15);
	}