...
void MyGraphicEngine::Draw(){
	...
	vaisseau->push_back(new Dame(-0.6, 0.8, 0.5f,0.5f,1.0f));
	vaisseau->push_back(new Dame(-0.4, 0.8, 0.5f, 1.0f, 1.0f));
	vaisseau->push_back(new Dame(-0.2, 0.8, 1.0f, 0.5f, 1.0f));
